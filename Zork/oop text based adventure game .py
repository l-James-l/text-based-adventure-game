...
class Prompts(Cmd):
    ...
    def do_veiw(self, args):
        "veiw your inventory, health or take a closer look at a specific item"
        veiw(player, args)
...
def make_rooms():
    ...
    cell.extra_info = "hint: Try reading that peice of paper, it might have something interesting on it"
